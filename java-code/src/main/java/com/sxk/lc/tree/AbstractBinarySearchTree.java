...
/**
 * Abstract binary search tree implementation. Its basically fully implemented binary search tree,
 * just template method is provided for creating Node (other trees can have slightly different nodes
 * with more info). This way some code from standart binary search tree can be reused for other
...
public class AbstractBinarySearchTree {
   ...
   * different nodes subclasses uses this abstract method to create nodes (maybe of class {@link
   * Node} or maybe some different node sub class).
   *
   ...
   * @return New node that is in place of deleted node. Or null if element for delete was not found.
   */
